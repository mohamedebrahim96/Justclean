...
class FavouritePostsAdapter : RecyclerView.Adapter<FavouritePostsAdapter.PostsViewHolder>() {
...
//            }
            binding.saveBTN.setOnClickListener {
                ...
                favouriteViewModel.whatIfNotNull {
                    runBlocking {
    ...
    fun setPostFavViewModel(favouriteViewModel: FavouriteViewModel) {
